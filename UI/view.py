...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.txt_distanza = ft.TextField(
            label="Diastanza Minima",
            width=200,
            hint_text="Inserisci distanza minima"
        )

        # button for the "hello" reply
        self.btn_analizza = ft.ElevatedButton(text="Analizza Aereoporti", on_click=self._controller.handleCreaGrafo)
